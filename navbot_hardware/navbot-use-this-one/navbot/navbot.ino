...
double left_kp = 3 , left_ki = 0 , left_kd = 0.0;             // modify for optimal performance
...
ros::Publisher left_wheel_pub("lwheel", &left_wheel_msg);                          //create a publisher to ROS topic "speed" using the "speed_msg" type
